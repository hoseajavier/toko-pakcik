...
const dataDetailProduct = [
  {
    ...
    type: "Uniform",
    variants: [
      { size: "3S", stock: 5, price: "Rp 110.000" },
      { size: "2S", stock: 5, price: "Rp 110.000" },
      { size: "S", stock: 4, price: "Rp 115.000" },
      { size: "M", stock: 0, price: "Rp 120.000" },
      { size: "L", stock: 3, price: "Rp 125.000" },
      { size: "XL", stock: 6, price: "Rp 130.000" },
      { size: "XXL", stock: 6, price: "Rp 135.000" },
      { size: "XXXL", stock: 5, price: "Rp 140.000" },
    ],
    image: tegiOsh,
  },
  {
    ...
    variants: [
      ...
      { size: "XL", stock: 0, price: "Rp 100.000" },
    ],
    image: gloveMerah,
  },
  {
    ...
    variants: [
      { size: "S", stock: 1, price: "Rp 100.000" },
      { size: "M", stock: 1, price: "Rp 100.000" },
      { size: "L", stock: 1, price: "Rp 100.000" },
      { size: "XL", stock: 0, price: "Rp 100.000" },
    ],
    image: gloveBiru,
  },
  {
    ...
    variants: [
      ...
      { size: "L", stock: 0, price: "Rp 200.000" },
      { size: "XL", stock: 2, price: "Rp 200.000" },
    ],
  ...
  },
  {
    ...
    variants: [
      ...
      { size: "L", stock: 2, price: "Rp 200.000" },
      { size: "XL", stock: 4, price: "Rp 200.000" },
    ],
    image: shinpadBiru,
  },
  {
    ...
    variants: [
      ...
      { color: "Red", stock: 0, price: "Rp 30.000" },
      { color: "Blue", stock: 1, price: "Rp 30.000" },
      { color: "Green", stock: 2, price: "Rp 30.000" },
      { color: "Brown", stock: 0, price: "Rp 30.000" },
      { color: "Dark Blue", stock: 12, price: "Rp 30.000" },
    ],
  ...
  },
  {
    ...
    name: "Tas OSH",
    type: "Bags",
    variants: [{ size: "All Size", stock: 6, price: "Rp 300.000" }],
  ...
  },
  {
    ...
    variants: [
      { size: "S", stock: 1, price: "Rp 200.000" },
      { size: "M", stock: 1, price: "Rp 200.000" },
      { size: "L", stock: 7, price: "Rp 200.000" },
